...
4. For Pinecone, Qdrant, or Chroma, select the same **Embedding** model used when the content was indexed.
...
| **Chroma** | Add endpoint, tenant, database, and API key if needed, select **Collection**, and select **Embedding**. |
