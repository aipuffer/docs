...
<Columns cols={2}>
  <Card title="OpenAI" icon="sparkles" href="#openai" horizontal>
    Text, images, embeddings, speech, web, and realtime.
  </Card>

  <Card title="Google" icon="sparkles" href="#google" horizontal>
    Gemini, images, video, embeddings, TTS, and grounding.
  </Card>

  <Card title="Claude" icon="sparkles" href="#claude" horizontal>
    Text, web search, and supported image analysis.
  </Card>

  <Card title="OpenRouter" icon="route" href="#openrouter" horizontal>
    Access many text, image, embedding, and web-capable models.
  </Card>

  <Card title="Azure" icon="cloud" href="#azure" horizontal>
    Azure OpenAI deployments for text, images, embeddings, and speech.
  </Card>

  <Card title="DeepSeek" icon="message-square" href="#deepseek" horizontal>
    Text generation for chat, writing, forms, and automations.
  </Card>

  <Card title="Ollama" icon="server" href="#ollama" horizontal>
