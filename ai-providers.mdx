...
<Columns cols={2}>
  ...
  <Card title="Claude" icon="/images/logos/providers/claude.svg" href="#claude" horizontal>
...
<Frame>
  <img src="/images/screenshots/ai-providers/claude-api-key-settings.png" alt="Claude API key settings" />
</Frame>
