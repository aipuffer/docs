...
<Columns cols={2}>
  ...
  <Card title="Vector Stores" icon="box" href="#manage-vector-stores" horizontal>
  ...
  <Card title="Manage Data" icon="list" href="#manage-data" horizontal>
  ...
  <Card title="Troubleshooting" icon="circle-help" href="#troubleshooting" horizontal>
