...
When **Optimize URL** is enabled, AI Puffer builds the <Tooltip headline="Slug" tip="The URL-friendly part of a WordPress post address.">slug</Tooltip> from the focus keyword when available. If no focus keyword is available, it uses the post title.
