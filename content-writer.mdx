...
Knowledge Base lets Content Writer use vector data you already added in **AI Puffer > Knowledge Base**.
...
2. Set **Context** to **OpenAI**.
3. Select one or more vector stores.
4. Click the settings icon and adjust the limit or threshold if needed.
...
1. Open **Knowledge Base**.
2. Set **Context** to **Pinecone**.
3. Select the Pinecone index.
...
1. Open **Knowledge Base**.
2. Set **Context** to **Qdrant**.
3. Select the Qdrant collection.
4. Click the settings icon.
5. Select the same embedding provider and model used when you added the data.
6. Adjust the limit or threshold if needed.
