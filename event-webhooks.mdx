...
> Screenshot placeholder: Developers settings with Event Webhooks enabled and a Signing Secret field.

> Screenshot placeholder: Webhook endpoint card showing endpoint name, URL, enabled switch, and subscribed events.
...
> Screenshot placeholder: Webhook Delivery Issues panel with failed jobs and Retry / Clear buttons.
