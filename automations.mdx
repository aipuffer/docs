...
5. Select the model.
6. In the right-side **General** card, click **Customize** next to **Prompts** if you need to edit prompts.
...
Knowledge Base lets content creation and Rewrite Content tasks use vector data from **AI Puffer > Knowledge Base**.
...
<Frame>
  <img src="/images/screenshots/automations/kb.png" alt="Vector" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/automations/kb-options.png" alt="Vector" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/automations/queue.png" alt="queue" />
</Frame>
