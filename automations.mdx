...
Set up the AI provider, image provider, vector store, or source connection required by the task you want to run.
...
Before creating the task, set up Google access:
...
> Screenshot placeholder: Automation task using Google Sheets with connected status.
