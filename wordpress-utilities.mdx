...
<Columns cols={2}>
  ...
  <Card title="Settings" icon="gear" href="#settings" horizontal>
    Enable utilities and manage assistant actions.
  </Card>
</Columns>

## Settings

Content Assistant settings control the post-list assistant and the editor assistants.

To configure them:

1. Go to **AI Puffer > Settings**.
2. Open **Integrations**.
3. Open **Content Assistant**.
4. Enable **Show on Post Lists** if you want the list-screen Assistant button and row menu.
5. Enable **Enable in Editors** if you want the Classic Editor and Block Editor assistants.
6. Choose the default **Insert Position**.
7. Add, edit, delete, reorder, or reset assistant actions.

<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Content Assistant settings" />
</Frame>

Each editor action has a label, a prompt, and an optional position. Use `%s` in the prompt where the selected editor text should be inserted.

<Info>
Editor actions and row menu suggestions use the default AI provider and model from **Settings > AI**. Bulk Assistant lets you choose the provider and model before running.
</Info>

Content Indexing has its own visibility setting.

To show or hide the **Index** button on post lists:
...
<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Knowledge Base setting for the post-list Index button" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Assistant button on a WordPress post list" />
</Frame>

<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Bulk Assistant modal" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Assistant row menu on a post list" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Index button on a WordPress post list" />
</Frame>

<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Add Content to Vector Store modal" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Index Status filter and column" />
</Frame>
...
1. Confirm **Enable in Editors** is turned on in Content Assistant settings.
2. Open a post or page in the Classic Editor.
3. Use the **Visual** editor.
4. Select the text you want to process.
5. Click **Assistant** in the editor toolbar.
6. Choose an action.
7. Review the inserted output.

<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Content Assistant in the Classic Editor toolbar" />
</Frame>
...
3. Select text inside a text-based block.
4. Click the Assistant icon in the block toolbar.
5. Choose an action.
6. Review the result.

<Frame>
  <img src="/images/screenshots/utilities/placeholder.svg" alt="Screenshot placeholder: Content Assistant in the Block Editor toolbar" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Assistant button is missing on post lists">
    Turn on **Settings > Integrations > Content Assistant > Show on Post Lists**. Also confirm the current user can edit the post type and has access to the Content Assistant module.
  </Accordion>
  ...
  <Accordion title="Pinecone or Qdrant indexing fails">
